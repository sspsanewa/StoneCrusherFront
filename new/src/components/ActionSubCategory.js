...
function ActionSubCategory(props) {
        ...
        <Box>
            ...
            >
                <Box paddingY={2} display={'flex'} flexDirection={'column'}>
                    ...
                    <Box paddingX={2} display={'flex'} alignItems={'center'} gap={1} sx={{ '&:hover': { backgroundColor: 'lightgray' } }}>
                        {props.editIcon}
                        {<PopupEditCategory editText={props.editText} render={props.render} setRender={props.setRender} setAnchorEl={setAnchorEl} button={props.edit} id={props.id} setShow1={props.setShow1} title={props.title} url={props.url1} />}
                    </Box>
