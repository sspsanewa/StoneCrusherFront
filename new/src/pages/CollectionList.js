...
const headCells = [
    ...
    { id: 'collection', numeric: false, label: 'Collection', minWidth: 100 },
...
function EnhancedTableToolbar(props) {
    ...
    return (
        <Typography marginBottom={4} fontSize={18} color={'gray'}>Collection List</Typography>
    );
}
...
export default function CollectionList() {
    ...
    return (
        <Box paddingY={4} paddingX={8} marginBottom={10} >
            <Helmet>
                <title>{Language.APP_NAME} | Manage Collections | Collections List</title>
            </Helmet>
            <Box display={'flex'} justifyContent={'space-between'}>
                <Box marginBottom={2} gap={1} display={'flex'}>
                    ...
                    <Typography marginTop={1.2} fontSize={20} >Manage Collections List</Typography>
                </Box>
                {show &&
