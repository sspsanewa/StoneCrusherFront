...
const headCells = [
    ...
    { id: 'totalSell', numeric: false, label: 'Total Sell', minWidth: 100 },

    { id: 'remainingAmount', numeric: false, label: 'Remaining Amount', minWidth: 100 },
    { id: 'finalTotalAmount', numeric: false, label: 'Final Total Amount', minWidth: 100 },
    // { id: 'email', numeric: false, label: 'Email', minWidth: 100 },

    { id: 'depositeAmount', numeric: false, label: 'Deposite Amount', minWidth: 100 },
...
function EnhancedTableToolbar(props) {
    ...
    return (
        <Typography marginBottom={4} fontSize={18} color={'gray'}>Monthly Report</Typography>
    );
}
...
export default function MonthlyReport() {
    ...
    React.useEffect(() => {
        ...
        axios.get(`${Url}/api/v1/report/all`, { params })
            .then(obj => {
                const res = obj.data;
    ...
    return (
        <Box paddingY={4} paddingX={8} marginBottom={10} >
            <Helmet>
                <title>{Language.APP_NAME} | Manage Monthly Report </title>
            </Helmet>
            <Box display={'flex'} justifyContent={'space-between'}>
                <Box marginBottom={2} gap={1} display={'flex'}>
                    ...
                    <Typography marginTop={1.2} fontSize={20} >Manage Monthly Report</Typography>
                </Box>
                            ...
                            {(search ? filteredRows : visibleRows).map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="left">{row.totalSell}</TableCell>

                                        <TableCell align="left">{row.remainingAmount}</TableCell>

                                        <TableCell align="left">{row.finalTotalAmount}</TableCell>



                                        <TableCell align="left">{row.depositeAmount}</TableCell>
                                        {/* <TableCell align="left">
