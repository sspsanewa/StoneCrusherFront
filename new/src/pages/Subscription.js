...
function EnhancedTableToolbar(props) {
    ...
    return (
        <Typography marginBottom={4} fontSize={18} color={'gray'}>Subscription List</Typography>
    );
}
...
export default function Subscription() {
    ...
    return (
        <Box paddingY={4} paddingX={8} marginBottom={10} >
            <Helmet>
                <title>{Language.APP_NAME} | Manage Subscription</title>
            </Helmet>
            <Box display={'flex'} justifyContent={'space-between'}>
                <Box gap={1} display={'flex'}>
                    ...
                    <Typography marginTop={1.5} fontSize={20} >Manage Subscriptions</Typography>
