...
const UserTabularReport = () => {
    ...
    return (
        <Box paddingY={4} paddingX={8} marginBottom={10} >
            <Helmet>
                <title>{Language.APP_NAME} | Users Tabular Report</title>
            </Helmet>
            ...
            <Box display={'flex'} justifyContent={'space-between'}>
                <Box marginBottom={2} gap={1} display={'flex'}>
                    ...
                    <Typography marginTop={1.2} fontSize={20} >Users Tabular Report</Typography>
                </Box>
                {show1 &&
...
export default UserTabularReport
