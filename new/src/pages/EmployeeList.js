...
export default function EmployeeList() {
    ...
    React.useEffect(() => {
        ...
        axios.get(`${Url}/api/v1/employee`, { params })
            .then(obj => {
                const res = obj.data;
    ...
    return (
        <Box paddingY={4} paddingX={8} marginBottom={10} >
            ...
            <Box marginBottom={2} display={'flex'} justifyContent={'right'}>
                <Box onClick={() => navigate(`/${APP_PREFIX_PATH}/addEmployee`)}>
                            ...
                            {(search ? filteredRows : visibleRows).map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <ActionUserList render={render} setRender={setRender} view='View' viewPath={`/${APP_PREFIX_PATH}/viewEmployee/`} id={row.employeId} viewIcon={<RemoveRedEyeIcon sx={{ color: Constant.color[0] }} />} statusValue={row.active_flag} status={row.active_flag === 1 ? 'Deactive' : 'Active'} url1='user_controller/active_deactive_status' statusIcon={<AirplanemodeActiveIcon sx={{ color: Constant.color[0] }} />} delete='Delete' url='api/v1/employee' delete_flag='0' deleteIcon={<DeleteIcon sx={{ color: Constant.color[0] }} />} setShow={setShow} setShow1={setShow1} editUrl='editEmployee' editIcon={<Edit sx={{ color: Constant.color[0] }} />} edit='Edit' />
                                        </TableCell>
