...
const headCells = [
    ...
    {
      id: 'empType', numeric: false, label: 'Employee Type', minWidth: 100
    },
...
function EnhancedTableToolbar(props) {
    ...
    return (
        <Typography marginBottom={4} fontSize={18} color={'gray'}>Employee List</Typography>
    );
}
                            ...
                            {(search ? filteredRows : visibleRows).map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="left">{row.employeeFirstName + ' ' + row.employeeLastName}</TableCell>
                                        <TableCell align="left">{row.employeeVillage}</TableCell>
